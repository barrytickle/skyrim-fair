...
internal static class FairCameos
{
        ...
        IReadOnlyList<(float X, float Y)> banners, Func<FormKey, PlacedNpc?> findActor)
    {
        ...
        script.Properties.Add(new ScriptFloatListProperty { Name = "CameoHolds3", Data = holds.ToExtendedList() });
        ...
        script.Properties.Add(new ScriptFloatListProperty { Name = "CameoEveryMin3", Data = config.Members.Select(m => m.Every[0]).ToExtendedList() });
        script.Properties.Add(new ScriptFloatListProperty { Name = "CameoEveryMax3", Data = config.Members.Select(m => m.Every[1]).ToExtendedList() });
        ...
        script.Properties.Add(new ScriptFloatListProperty { Name = "CameoMoveMin3", Data = config.Members.Select(m => m.Move[0]).ToExtendedList() });
        script.Properties.Add(new ScriptFloatListProperty { Name = "CameoMoveMax3", Data = config.Members.Select(m => m.Move[1]).ToExtendedList() });
        script.Properties.Add(new ScriptFloatProperty { Name = "CameoDuckLevel", Data = config.DuckLevel });
