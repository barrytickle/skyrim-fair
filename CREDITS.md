...
| Fair worldspace light towers | `meshesarry_scaffold\scaffold.nif`, `texturesarry_scaffold\scaffold_d.dds`, `scaffold_n.dds` | Barry's scaffold watchtower | Barry (original source to confirm) | Pending: record the source and licence | Bundled |
