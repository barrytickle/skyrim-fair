...
| Market goods (148 props) | `meshes\SkyrimFair\Props\*.nif`, generated by `tools/make_static_props.py` | Skyrim | Bethesda Game Studios | Vanilla meshes with collision unhooked, as mods routinely ship | Built mod only; kept out of git |
