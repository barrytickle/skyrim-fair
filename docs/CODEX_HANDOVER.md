...
- **retiring a market piece**: set it `reserve: true` rather than deleting it; it places nothing but keeps its FormID, so nothing after it renumbers (the outhouse doors, 2026-09-25)
