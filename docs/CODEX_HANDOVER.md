...
- **dances play once and loop**: the stage script starts each dancer's idle once per song, and the cheer idle ends it. Re-triggering a looping idle restarts it visibly
